...
dataframe = pd.read_csv(r"/home/sandeep/Downloads/Student-Performance-Portfolio-WebApp-master/Datasets/collegePlacementData.csv")
...
with st.sidebar:
    selected = option_menu(
        menu_title = "...HADucate...",
        options = ["Home", "Upload CSV", "Analysis", "Predictions", "Performance", "Download CSV", "Settings", "Tools","peep","socio"],
...
if selected=="socio":
    st.markdown('<meta http-equiv="refresh" content="0; url="http://127.0.0.1:8009/" />', unsafe_allow_html=True )
# #== socio tab==
# if selected == "socio":
#     st.markdown('<meta http-equiv="refresh" content="0; url=http://127.0.0.1:8009/" />', unsafe_allow_html=True)
...
if selected == "Home":
    ...
    with col1:
        st.title('⚛️  ...HADucate...  ⚛️ ')
        st.header("Placement Management 🏠 And")
        st.header("Recruitment Tool 🔮")
        st.divider()
        st.header("About :memo:")
        st.markdown('''
        ####
        We are thrilled to introduce you to HADucate, your all-in-one solution for student
        ...
        With HADucate, educational institutions can efficiently manage student data,
        ...
        student management and recruitment with HADucate!
        ''')
    ...
    with col2:
        ...
        st.image("/home/sandeep/Downloads/Student-Performance-Portfolio-WebApp-master/Images/home_tab_pic.png")
# this is the project which is creat by us 
# ========= UPLOAD TAB =========
if selected == "Upload CSV":
    ...
    with col2:
        ...
        st.image("/home/sandeep/Downloads/Student-Performance-Portfolio-WebApp-master/Images/upload_tab_pic.png")
...
if selected == "Analysis":
    ...
    with col2:
        ...
        st.image("/home/sandeep/Downloads/Student-Performance-Portfolio-WebApp-master/Images/Analysis_tab_pic.png")
...
if selected == "Predictions":
    ...
    with col2:
        ...
        st.image("/home/sandeep/Downloads/Student-Performance-Portfolio-WebApp-master/Images/prediction_tab_pic.png")
...
if selected == "Settings":
    ...
    if send_button:
        ...
        st.markdown("#### <span style = 'color:yellow'>Team Coding Burners</span>", unsafe_allow_html=True)
...
# if selected == "Tools":
#     st.title("Tools ⚡")
#     st.header("Team Code Burners 🔥 ")

#     col1, col2, col3 = st.columns(3)
#     with col1:
#         st.image("Images/harsh1.jpeg")
#         st.subheader("1️⃣ Peep")
#         st.markdown('''
#             * **`Link`** ⭐  
#                 http://127.0.0.1:8009
#            ''')
...
#     with col2:
#         st.image("Images/deepam3.jpeg")
#         st.subheader("2️⃣  Socio ")
#         st.markdown('''
#             * **`link`** ⭐
#                 http://127.0.0.1:8000/
...
#         ''')
    # with col3:
    #     st.image("Images/ankit2.jpg")
    #     st.subheader("3️⃣ Ankit Singh")
    #     st.markdown('''
    #         * **`Github`** ⭐
    ...
    #         * **`Portfolio`** 🌐
    #             https://shrekar.github.io/Portfolio
    #     ''')

# if selected == "Tools":
#         st.markdown("<h1 style='text-align: center;'>Tools ⚡</h1>", unsafe_allow_html=True)
#         st.markdown("<h2 style='text-align: center;'>Team Code Burners 🔥</h2>", unsafe_allow_html=True)
...
#                 <a href='http://127.0.0.1:8009' target='_blank'>
#                     <button style='padding:10px 20px; font-size:16px; cursor:pointer;'>Visit Peep</button>
#                 </a>
#             </div>
...
#                     <button style='padding:10px 20px; font-size:16px; cursor:pointer;'>Visit Socio</button>
#                 </a>
#             </div>
#             """, unsafe_allow_html=True)
# if selected == "Tools":
...
#         with col1:
#             st.image("Images/harsh1.jpeg", width=150)  # Adjust the width to make the image smaller
#             st.subheader("1️⃣ Peep")
#             st.markdown("""
#             <div style='text-align: center;'>
#                 <a href='http://127.0.0.1:8009' target='_blank'>
#                     <button style='padding:10px 20px; font-size:16px; cursor:pointer; background-color: #f44336; color: white; border: none; border-radius: 5px;'>Visit Peep</button>
#                 </a>
#             </div>
#             """, unsafe_allow_html=True)

#         with col2:
#             st.image("Images/deepam3.jpeg", width=150)  # Adjust the width to make the image smaller
#             st.subheader("2️⃣ Socio")
#             st.markdown("""
#             <div style='text-align: center;'>
#                 <a href='http://127.0.0.1:8000/' target='_blank'>
#                     <button style='padding:10px 20px; font-size:16px; cursor:pointer; background-color: #f44336; color: white; border: none; border-radius: 5px;'>Visit Socio</button>
#                 </a>
#             </div>
#             """, unsafe_allow_html=True)

#         with col3:
#             st.image("Images/ankit2.jpg", width=150)  # Adjust the width to make the image smaller
#             st.subheader("3 Editor")
#             st.markdown("""
#             <div style='text-align: center;'>
#                 <a href='http://localhost:5173/' target='_blank'>
#                     <button style='padding:10px 20px; font-size:16px; cursor:pointer; background-color: #f44336; color: white; border: none; border-radius: 5px;'>Visit coeditor</button>
#                 </a>
#             </div>
#             """, unsafe_allow_html=True)
